...
class Research:
    ...
    class Calculations:
        ...
        def counts(self, content: list[list[int]]) -> tuple[int, int]:
            """
...
if __name__ == "__main__":
    ...
    try:
        class_obj = Research(file_name)
        data = class_obj.file_reader(has_header=True)

        calculations = class_obj.Calculations()
        ...
        print(data)
        print(heads, tails)
        print(round(heads_ratio, 4), round(tails_ratio, 4))
