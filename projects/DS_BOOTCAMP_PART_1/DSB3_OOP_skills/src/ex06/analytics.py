...
class Research:
    ...
    def __init__(self, filename: str) -> None:
        ...
        """
        logging.info("Initializing `Research` class object")
        dirname = os.path.dirname(os.path.dirname(os.path.realpath(__file__)))
        self.file_path = os.path.join(dirname, filename)

    def notification(self, success: bool, webhook_url: str, token: str) -> int:
        """
        Notificate user in private Telegram chennel.

        Parameters
        ----------
        success : bool
            Status of creating report
        webhook_url : str
            Url of n8n webhook backend
        token : str
            N8n futhorization token
    ...
    def check_file_content(self, text: str, has_header: bool) -> None:
        ...
        """
        logging.info("Walidateing file content")
        lines = [line.strip()
                 for line in text.strip().split("\n") if line.strip()]
    ...
    class Calculations:
        ...
        def __init__(self, content: list[list[int]]) -> None:
            ...
            """
            logging.info("Initializing `Calculations` class object")
            self.data = content
        ...
        def fractions(self, heads: int, tails: int) -> tuple[float, float]:
            ...
            """
            logging.info("Calculating fractions of heads and tail")
    ...
    class Analytics(Calculations):
        ...
        def predict_last(self) -> list[int]:
            ...
            logging.info("Extracting last value")
            return self.data[-1]
